...
import (
	...
	"github.com/gryph/omnidex/autonomy-proof/final-01-pocket-tasks/domain"
	"github.com/gryph/omnidex/autonomy-proof/final-01-pocket-tasks/storage"
)
...
func main() {
	...
	case "add":
		...
		title := args[1]
		if title == "" {
			log.Fatal("Task title cannot be empty")
		}
