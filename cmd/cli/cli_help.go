...
func usage() {
	...
	fmt.Println("  bench:replay (--opening id | --job id [--work-kind kind]) --model name [--model name...] --report path [--timeout 0] [--compiler-converge --guidance-model name | --current-contract | --specification-converge]")
