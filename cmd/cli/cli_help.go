...
func usage() {
	...
	fmt.Println("  service [--service name] <up|down|restart|status|logs|docker-logs|start|stop|build> [options]")
	fmt.Println("  service:<name> <up|down|restart|status|logs|docker-logs|start|stop|build> [options]")
	fmt.Println("  --service <name> <up|down|restart|status|logs|docker-logs|start|stop|build> [options]")
