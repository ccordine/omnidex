...
func writeDefaultConfigFile(path string) error {
	content := strings.Join([]string{
		...
		"# OMNI_CONVERSATION_OBJECTIVE_KIND_MODEL=llama3.2",
		"# OMNI_ROLEPLAY_CANON_EXTRACTION_MODEL=llama3.2",
		"# OMNI_ROLEPLAY_ONGOING_ACTION_MODEL=llama3.2",
		"# OMNI_GROUNDED_ANSWER_MODEL=llama3.2",
		"# OMNI_DATABASE_SCHEMA_SELECTION_MODEL=llama3.2",
		"# OMNI_DATABASE_QUERY_INTENT_MODEL=llama3.2",
