...
DO $$
BEGIN
    IF NOT station_owns_portable_work('roleplay_narrative_continuity','roleplay_narrative_continuity','{}'::jsonb)
       OR station_owns_portable_work('conversation_response','roleplay_narrative_continuity','{}'::jsonb)
       OR station_owns_portable_work('roleplay_narrative_continuity','conversation_response','{}'::jsonb) THEN
        RAISE EXCEPTION 'roleplay narrative continuity station authority postcondition failed';
    END IF;
END $$;
