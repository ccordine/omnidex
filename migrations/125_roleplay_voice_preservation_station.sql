...
DO $$
BEGIN
    IF NOT station_owns_portable_work('roleplay_voice_preservation','roleplay_voice_preservation','{}'::jsonb)
       OR station_owns_portable_work('roleplay_voice_rewrite','roleplay_voice_preservation','{}'::jsonb)
       OR station_owns_portable_work('roleplay_voice_preservation','roleplay_voice_rewrite','{}'::jsonb) THEN
        RAISE EXCEPTION 'roleplay voice preservation station authority postcondition failed';
    END IF;
END $$;
