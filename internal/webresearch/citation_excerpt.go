...
const (
	MaxCitationExcerptBytes           = 2 * 1024
	objectiveEvidenceTruncationMarker = "\n...[truncated]"
)

// CitationExcerpt is the shared projection used for model capsules and for
// checking persisted citations against the recorded fetched source.
func CitationExcerpt(projected ProjectedEvidence) (string, bool, error) {
	maximum := MaxCitationExcerptBytes
	values := []string{projected.Title, projected.Snippet, projected.Content}
