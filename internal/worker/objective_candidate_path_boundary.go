...
func validateObjectiveRawCandidatePathBoundary(
	...
	case assemblyline.WorkContextRelevanceRelation,
		...
		assemblyline.WorkRoleplayCanonFactPresence,
		...
		assemblyline.WorkRoleplayOngoingActionRelation,
		assemblyline.WorkRoleplayOngoingActionValue,
		...
		assemblyline.WorkDatabaseSchemaRelationChoice,
		assemblyline.WorkDatabaseQueryFromRelation,
		assemblyline.WorkDatabaseQueryShape,
		assemblyline.WorkDatabaseQueryPurposePresence,
