...
func TestModelSettingsUsesExactStationCatalog(t *testing.T) {
	...
	for _, removed := range []string{"default_model", "fast_model", "glue_model", "reasoning_model", "planner_model", "analyzer_model", "responder_model", "tagger_model", "search_model", "memory_model", "executor_model", "thinking_model", "evaluator_model", "file_worker_model", "coding_plan_model", "coding_repair_model", "coding_file_model", "coding_source_review_model", "coding_source_model", "coding_requirement_quote_model", "coding_semantic_check_model", "coding_semantics_model", "coding_requirement_adviser_model", "coding_requirement_split_model", "coding_skill_procedure_model"} {
