...
func TestPolicyAllowsHomeProjectsPath(t *testing.T) {
	decision := EvaluateCommandPolicy("mkdir -p ~/Projects/omni-project", t.TempDir())
...
func TestPolicyBlocksHomeOutsideProjects(t *testing.T) {
	decision := EvaluateCommandPolicy("mkdir ~/Desktop/omni-project", t.TempDir())
...
func TestPolicyBlocksCD(t *testing.T) {
	decision := EvaluateCommandPolicy("cd ~/Projects/omni-project", t.TempDir())
