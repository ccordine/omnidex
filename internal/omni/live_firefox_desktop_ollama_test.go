...
`, logPath))
	...
	url := "https://example.com/omni-firefox-test"
...
func TestLiveOllamaOpensFirefoxTabByPID(t *testing.T) {
	...
	if strings.TrimSpace(os.Getenv("OMNI_RUN_DESKTOP_LIVE")) == "" {
		t.Skip("set OMNI_RUN_DESKTOP_LIVE=1 to allow this test to focus Firefox and open a real browser tab")
	}
	...
	url := "https://example.com/omni-firefox-live-test"
