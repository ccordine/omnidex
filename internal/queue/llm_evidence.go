...
func insertLLMCallEvidenceTx(
	...
	err = scanLLMCallEvidence(tx.QueryRow(ctx, `
		...
		VALUES ($22,$23,$1,$2,NULLIF($3,''),NULLIF($4,''),NULLIF($5,''),$6,$7,$8,
		        $9,$10,$11,$12,$13::jsonb,$14,$15,$16,$17,$18,$19,NULLIF($20,''),$21,
		        $24,$25,$26)
		RETURNING id, job_id, job_generation, step_id, step_attempt, worker_id,
		          ...
		          response_sha256, status, error, latency_ms, created_at, station_call_opening_id
