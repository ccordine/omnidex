...
func persistObjectivePortableReuseLeaf(
	t *testing.T,
	repository *Repository,
...
func persistRejectedObjectivePortableReuseLeaf(
	t *testing.T,
	repository *Repository,
	claim *model.ClaimedStep,
	portable assemblyline.PortableJob,
...
func objectivePortableReuseStation(t *testing.T, job assemblyline.PortableJob) station.ID {
	t.Helper()
