...
var fieldRegistry = []fieldDefinition{
	...
	{Key: "coding_requirements_model", Label: "Coding intent", Description: "Returns one bounded product or stack value, one untrusted context-question or requirement inventory, or one candidate-bound sieve result per coding-intent call", EnvironmentKey: "OMNI_CODING_REQUIREMENTS_MODEL", Stations: []station.ID{station.CodingRequirements, station.CodingProjectStackConstraint}},
