...
var Fields = []Field{
	...
	{Key: "coding_workload_review_model", Label: "Coding acceptance grounding", Description: "Grounds one generated acceptance declaration against its exact public observations", EnvKeys: []string{"OMNI_CODING_WORKLOAD_REVIEW_MODEL"}},
