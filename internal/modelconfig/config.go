...
var Fields = []Field{
	{Key: "context_relevance_model", Label: "Context relevance", Description: "Judges one code-known context candidate against one exact instruction", EnvKeys: []string{"OMNI_CONTEXT_RELEVANCE_MODEL"}},
	...
	{Key: "grounded_answer_model", Label: "Grounded answer", Description: "Returns one bounded untrusted paragraph inventory, one evidence-support relation, or one paragraph-authorization relation per repository-grounding call", EnvKeys: []string{"OMNI_GROUNDED_ANSWER_MODEL"}},
	{Key: "database_schema_selection_model", Label: "Database schema selection", Description: "Selects the model for separate bounded relation-responsibility inventory, candidate-necessity, and registered-relation resolution calls", EnvKeys: []string{"OMNI_DATABASE_SCHEMA_SELECTION_MODEL"}},
	...
	{Key: "repository_evidence_relevance_model", Label: "Repository evidence relevance", Description: "Judges one repository evidence candidate against one exact requirement", EnvKeys: []string{"OMNI_REPOSITORY_EVIDENCE_RELEVANCE_MODEL"}},
	{Key: "web_relevance_model", Label: "Web relevance", Description: "Judges one code-known web evidence candidate against one exact question", EnvKeys: []string{"OMNI_WEB_RELEVANCE_MODEL"}},
