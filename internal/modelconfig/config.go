...
var Fields = []Field{
	...
	{Key: "roleplay_ongoing_action_model", Label: "Roleplay ongoing action", Description: "Returns one character's complete current ongoing-action leaf or explicit absence from one exact visible contribution", EnvKeys: []string{"OMNI_ROLEPLAY_ONGOING_ACTION_MODEL"}},
