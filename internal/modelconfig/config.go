...
var Fields = []Field{
	...
	{Key: "coding_requirements_model", Label: "Coding intent", Description: "Identifies bounded context needs and derives or repairs reviewed semantic application intent", EnvKeys: []string{"OMNI_CODING_REQUIREMENTS_MODEL"}},
